...
$routeBase = '/CursoPlatziPHP/curso-introduccion-php-35-man-sesiones';
...
if (!$route) {
    ...
    if ($needsAuth && !isset($_SESSION['userId'])) {
      $response = new RedirectResponse('/CursoPlatziPHP/curso-introduccion-php-35-man-sesiones/login');
    }else {
